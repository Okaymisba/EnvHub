...
export const InviteMemberModal: React.FC<InviteMemberModalProps> = ({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[450px] bg-black border border-purple-800 text-white max-h-[90vh] overflow-hidden flex flex-col">
                <style jsx global>{`
                ...
                `}</style>
                <div className="overflow-y-auto px-1 scrollbar-custom pr-2">
                    <DialogHeader>
