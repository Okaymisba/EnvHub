...
import { ArrowLeft, CreditCard, Calendar, X } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <Card className="bg-gray-800 border-purple-600">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold text-white mb-4">$4<span className="text-sm text-gray-400">/month</span></div>
                ...
                <Card className="bg-gray-800 border-blue-600">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold text-white mb-4">$10<span className="text-sm text-gray-400">/month</span></div>
                    <ul className="space-y-2 text-sm text-gray-300 mb-6">
