...
export default function Signup() {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up - EnvSecure Vault Keeper</title>
        <meta name="description" content="Create your EnvSecure Vault Keeper account to securely manage your environment variables and secrets." />
        <meta name="keywords" content="envsecure, vault keeper, environment variables, secrets management, sign up" />
      </Helmet>
