      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Secure, Simple, and <span className="bg-gradient-to-r from-purple-400 via-pink-500 to-blue-500 bg-clip-text text-transparent">Scalable</span>
          </h1>
        ...
        <div className="space-y-16">
          <section className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-8 border border-gray-800">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              At EnvHub, we believe in making environment variable management as secure and straightforward as possible.
              Our mission is to provide developers with the tools they need to manage their application configurations
          ...
          <section className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-8 border border-gray-800">
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 flex items-center justify-center">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white">Security First</h3>
                  <p className="text-gray-400">We prioritize the security of your sensitive data above all else.</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-r from-purple-600 to-pink-500 flex items-center justify-center">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div>
              ...
              <li className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-r from-orange-600 to-red-500 flex items-center justify-center">
                  <Lock className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white">Transparency</h3>
                  <p className="text-gray-400">We believe in being open about how we handle your data.</p>
                </div>
              </li>
            </ul>
          </section>
