...
const Blog = () => {
    useEffect(() => {
        ...
        script.src = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8798851790254180';
        script.async = true;
        ...
        script.onload = () => {
            try {
                // @ts-expect-error - adsbygoogle is a global variable from the Google AdSense script
        ...
        <div className="min-h-screen flex flex-col bg-black text-white">
            <Helmet>
                ...
                <meta name="description"
                      content="Stay updated with the latest insights, tutorials, and news about Envhub and modern development workflows."/>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                            Latest articles, tutorials, and news about environment variables, security, and development
                            best practices.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {/* AdSense Script is loaded via useEffect */}
                                    ...
                                    <Link to={`/blog/${post.slug}`} className="block h-full">
                                        ...
                                        <div className="p-6">
                                            <div
                                                ...
                                                <div
                                                    className="flex items-center gap-1.5 bg-gray-800/50 px-3 py-1 rounded-full">
